-- Add workout programs system to existing database
...
('PPL', 'Push Pull Legs - 3 günlük döngü antrenman sistemi', 'Dumbbell', 'bg-blue-500'),
('Full Body', 'Tüm vücut kaslarını çalıştıran komple antrenmanlar', 'Activity', 'bg-orange-500'),
('Split', 'Kas gruplarına göre ayrılmış split antrenman programları', 'Target', 'bg-green-500')
